    ...
    def split(self):
        ...
        for attribute in self.input_names:
            ...
            for val in unique_values:
                subset_indices = self.input_columns[self.input_columns[attribute] == val].index
                subset_target = self.target_column.loc[subset_indices]
                weight = len(subset_target) / len(self.target_column)
                conditional_entropy += weight * Utils.entropy(subset_target)
